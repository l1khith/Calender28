...
| 12 | **Customizable & Reorderable Bottom Navigation** | [12_customizable_bottom_nav.md](12_customizable_bottom_nav.md) | `CustomizeNavScreen`, `CustomizeNavViewModel`, `NavPreferencesRepository`, Reorderable Drag-and-Drop Dock |
| 13 | **Time-Bounded Events, Day Detail Screen & Conflict Detection** | [13_time_bounded_events_and_day_detail.md](13_time_bounded_events_and_day_detail.md) | `DayDetailScreen`, `HourTimeline`, `DetectTaskConflictsUseCase`, `GetDayConflictsUseCase`, `GetDayDetailUseCase` |
